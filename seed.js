...
mongoose.connect("mongodb+srv://bank:0ztAVlUG9mtzHG26@cluster0.rk1ef.mongodb.net/bank?retryWrites=true&w=majority", { useUnifiedTopology: true, useNewUrlParser: true })
    .then(() => {
